...
export function LoginBackground({
  ...
  return (
    <>
      <div className={`absolute inset-0 ${Z.SKY} bg-linear-to-b from-[#4fc3f7] to-white dark:from-[#0f0c29] dark:to-[#302b63]`}>
        <div
      ...
      <div className={`absolute top-4 right-24 size-56 rounded-full blur-[80px] pointer-events-none select-none ${Z.GLOW} bg-[rgba(255,160,0,0.6)] dark:bg-[rgba(255,255,255,0.5)] max-[1200px]:hidden`} />
      <button
        type="button"
        onClick={(e) => toggleTheme({ x: e.clientX, y: e.clientY })}
        className={`absolute top-12 right-32 size-32 cursor-pointer ${Z.TOGGLE} max-[1200px]:hidden`}
