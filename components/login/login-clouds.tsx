    ...
    <div className="absolute inset-0 z-[1] pointer-events-none overflow-hidden dark:hidden">
      ...
      <div className="absolute top-[60%] left-[5%] opacity-75">
        <div className="relative w-44 h-[18px]">
          ...
          <div className="absolute bottom-0 left-0 w-full h-[9px] bg-white/80 rounded-full" />
        </div>
      </div>
      ...
      <div className="absolute top-36 left-[3%] opacity-50">
        <div className="relative w-80 h-28 blur-[1px]">
          ...
          <div className="absolute bottom-0 left-36 w-28 h-[18px] bg-white rounded-full" />
      ...
      <div className="absolute top-[55%] left-[40%] opacity-45">
        <div className="relative w-72 h-24 blur-[1px]">
          ...
          <div className="absolute bottom-0 left-0 w-full h-[10px] bg-white rounded-full" />
        </div>
      </div>
      ...
      <div className="absolute top-28 right-[22%]">
        <div className="relative w-52 h-22">
          ...
          <div className="absolute -top-1 left-8 w-22 h-[18px] bg-white/80 rounded-full" />
          <div className="absolute bottom-0 left-0 w-full h-[10px] bg-white/80 rounded-full" />
        </div>
      </div>
      ...
      <div className="absolute bottom-8 left-[55%] opacity-80">
        <div className="relative w-44 h-16">
          ...
          <div className="absolute bottom-0 left-0 w-full h-[9px] bg-white/70 rounded-full" />
        </div>
      </div>
    </div>
  )
