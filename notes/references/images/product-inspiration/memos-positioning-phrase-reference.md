# Memos Positioning Phrase Reference
...
- `not`: defines the product by rejecting oversized categories.
- `workspace`: signals that the product is not trying to become a full
  productivity suite.
